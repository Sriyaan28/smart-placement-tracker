...
import { Briefcase, MapPin, IndianRupee, Clock, ChevronDown, Check, X, AlertCircle } from 'lucide-react';
...
export const PostJob = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.success) {
        // Refresh context to show new job instantly
  ...
  return (
    <div className="w-full max-w-4xl mx-auto pb-20 animate-in fade-in duration-500">
      <div className="mb-8">
        ...
        <p className="text-zinc-400">Fill out the details below to publish a new opportunity.</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-2">
            ...
            <textarea 
              ...
              onChange={handleChange} 
              className="w-full bg-black border border-zinc-800 rounded-xl px-4 py-3 text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors outline-none resize-none placeholder:text-zinc-600 h-24" 
          ...
          <div className="pt-6">
            <button 
              ...
              className="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-4 px-6 rounded-xl flex items-center justify-center gap-2 transition-all shadow-[0_0_20px_rgba(59,130,246,0.3)] disabled:opacity-50 disabled:shadow-none"
            >
              {isSubmitting ? (
